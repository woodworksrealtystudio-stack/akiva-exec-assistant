...
**Inbox triage:**
- Claude reads new emails (via Composio Gmail MCP)
...
**Calendar:**
- Claude has read access to his Google Calendar (via Composio Calendar MCP)
...
2. **Day 14:** Composio Gmail + Calendar MCP connected. Claude triages real inbox in batches Akiva runs on demand.
